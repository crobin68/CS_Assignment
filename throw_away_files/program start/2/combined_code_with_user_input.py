...
#======================================================================================================================================================================================================================================
         ...
         # view event details option #2
                ...
                event_two_stuff = ["Event Details:", "Title:" , "test title" ,"Date:","8539-12-15" , "Attendees:" , "person1", "person2", "person3"]
                glue2 = ','
                people2 = glue2.join(event_one_stuff[6:]) #get names of people
                ...
                # prompt user if they want to go to main menu
                def go_to_main_menu():
                    startover2 = input("Would you like to go to the beggining?\n 1) Yes\n 2) No\n please type in the option you want = ")
                    
                    # when in event detil #1 give user option to go to main menu or term the code
                    if int(startover2) == 1:
                        selection()
                        # end the program if you selects (2)
                    elif int(startover2) == 2:
                        print("program ending in")
                        time.sleep(1)
                        print("3...")
                        time.sleep(1)
